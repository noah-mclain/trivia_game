...
public class TriviaGame extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        // FXMLLoader(TriviaGame.class.getResource("login_menu.fxml"));
    ...
    // TranslateTransition(Duration.seconds(2), text);
    ...
    // AudioClip(getClass().getResource(soundEffectPath).toExternalForm());
    // audioClip.play();
    // }
